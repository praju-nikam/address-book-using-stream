...
public class AddressBookSystemMain
{
    public static void main(String[] args) {
        ...
        Map<String, AddressBookSystemDetails> addressBookMap = new HashMap<>();
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    scanner.nextLine();
                    addressBookMap.put(bookName, new AddressBookSystemDetails());// adding book name as a key and value is allocating
